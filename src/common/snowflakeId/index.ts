export class snowflakeIdOption {
  /**
...
export class snowflakeId {
   ...
   * @memberof Genid
   */
  constructor(options: snowflakeIdOption) {
  ...
  public NextNumber(): number {
    if (this._IsOverCost) {
      ...
      if (id >= BigInt('9007199254740992')) throw Error(`${id.toString()} over max of Number 9007199254740992`);
